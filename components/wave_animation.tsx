...
export default function WaveAnimation() {
  ...
  useEffect(() => {
    ...
    let animId: number;
    let t = 0;
    const BULGE_SIZE = 2; // adjust: 2 = subtle, 8 = strong bulge
    ...
    function draw() {
      ...
      for (let r = 0; r < RINGS; r++) {
        ...
        for (let p = 0; p < count; p++) {
          ...
          // 🎨 Purple shades only
          const hue = 280 + Math.sin(angle * 2 + t + r * 0.3) * 20;
          // stays between ~260–300
          ...
          if (pointerX !== null && pointerY !== null) {
            ...
            if (dist < 80) {
              ...
              radius += factor * BULGE_SIZE; // bulge size control
          ...
          ctx.fillStyle = `hsla(${hue | 0}, 80%, ${lit | 0}%, ${alpha.toFixed(2)})`;
